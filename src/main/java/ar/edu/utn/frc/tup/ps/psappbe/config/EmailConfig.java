...
import ar.edu.utn.frc.tup.ps.psappbe.services.mail.EmailServiceGmailImpl;
...
public class EmailConfig {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT)
            throws IOException {
        // Load client secrets.
        InputStream in = EmailServiceGmailImpl.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
